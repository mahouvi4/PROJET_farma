...
<head>
  <title>Pharma-plat &mdash; Sysrem</title>
  <meta charset="utf-8">
...
@if(! session('info_user'))
  ...
  <div class="site-wrap">
          ...
          <div class="main-nav d-none d-lg-block">
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                <li><a href="{{url('show_medico_pharma/'.request()->session()->get('idemail'))}}">Home</a></li>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="{{url('show_medico_pharma/'.request()->session()->get('idemail'))}}">Home</a> <span class="mx-2 mb-0">/</span> <strong
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="lead mb-5">Payment made successfully.</p>
            <p><a href="{{url('show_medico_pharma/'.request()->session()->get('idemail'))}}" class="btn btn-md height-auto px-4 py-3 btn-primary">Back to store</a></p>
          </div>
        </div>
      </div>
    </div>
