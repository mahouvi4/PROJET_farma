...
<html>
    ...
    <body style="background-image: url('{{asset('images/bingo.jpg')}}');background-repeat:no-repeat;background-attachment:fixed;background-size:cover">
        ...
        <div class="container">
            ...
            <input type="button" value="Login ♣" id="bomx" style="background-color: #ff0f5b;border:none; height:38px;width:100%; border-radius: 16px;margin-left:32px" class="form-control button vexpo" />
...
document.getElementById("eiaa").innerHTML = "<p style='margin-top:-150px;font-family:Forte;font-size:2.3rem ;background: -webkit-linear-gradient(0.25turn, #ea37fa, #fff, #2af8cb);-webkit-background-clip: text;-webkit-text-fill-color: transparent;'>PHARMA-PLAT<p/>"

             $(function(){
                    $("#bomx").on("click",function(){
