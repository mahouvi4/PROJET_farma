      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black"> Customer complaint list</strong>
          </div>
        </div>
      </div>
    </div>
     ...
     $created_at = 0;
          ...
          @endphp
                ...
                @php
                                  ...
                                  $created_at = Date("d-m-y",strtotime($h_acto));
                                      ...
                                      @if($item->statut == 0)
                                     <td style="color:#DC143C;font-family:aharoni">awaiting response. . .</td>
                                     @elseif($item->statut == 1)
                                     <td style="color:green;font-family:aharoni"> answered. . .</td>
                    ...
                    <td>
                           @if($item->statut == 0)
                           <a href="{{url('admin/response_cli/'.$item->id)}}" > <button type="button"  class="btn btn-dark">RESPOND</button></a>

                             @elseif($item->statut == 1)
                               <button type="button"  class="btn btn-info">ANSWERED</button> 
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row mb-5">
              <div class="col-md-6 mb-3 mb-md-0">
                <a href="#"><button class="btn btn-primary btn-md btn-block">xx</button></a>
              </div>
              <div class="col-md-6">
              </div>
            </div>
