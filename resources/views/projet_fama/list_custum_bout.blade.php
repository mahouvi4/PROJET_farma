      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">List Custumer</strong>
          </div>
        </div>
      </div>
    </div>
          ...
          <form class="col-md-12" method="post">
            <div class="site-blocks-table">
              <table class="table table-bordered">
                ...
                <thead>
                    <tr>
                        <td>Pharmacy Name: <h1 style="color:rgb(0, 247, 255) ;font-family:cambria;width:100%">{{$phx->name_pharma}}</h1>
                ...
                <tbody>
                  ...
                  <td class="product-thumbnail">
                           <img src="{{asset('Pharmacie/'.$phx->photo)}}" alt="" height="200px" width="100%" style="border-radius:15px">
                          </td>
                    </tr>
                 ...
                 <table class="table table-bordered">
                      <thead>
                          ...
                          <tbody>
                                    @foreach($list_custumer_by_boutiq as $item)
                                        <tr>
                                            ...
                                            <td><a href="{{url('admin/formulaire_comuniq_pharma_client/'.$item->email)}}" class="btn btn-primary height-auto btn-sm mt-2" style="width:100%">To contact</a></td>
