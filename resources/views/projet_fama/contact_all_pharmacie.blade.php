...
<div class="blur"></div>
        ...
        <div class="group-control">
                    <h1 style="text-align:center;color:#36F2DF">♠send message for all pharmacy♠</h1>
                   </div>
            <div class="content">
                <div class="kiko"></div>
            <form id="difi">
                  ...
                  <div class="control-group mt-4">
                    ...
                    <br>
                  <div class="group-control">
                         <button type="button" class="btn btn-info" id="send_phamo">Send♠</button>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js"
 ...
 <script>
          ...
          $(document).on('click','#send_phamo',function(){
       ...
       $.ajaxSetup({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')}});
           $.ajax({
               type:"post",
               url:"{{url('admin/send_all_pharmacie')}}",
               data:{
