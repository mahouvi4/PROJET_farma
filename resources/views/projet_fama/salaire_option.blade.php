                ...
                <tbody>
                  ...
                  <td class="product-thumbnail">
                    ...
                    <td class="product-name"><h1>OPTION</h1></td>
                       ...
                       <tr>
                          <td> <a href="{{url('alization/pagamento/'.$opt->id)}}" class="btn btn-warning height-auto btn-sm mt-2" style="width:100%">Return Salary♣</a></td>
                     ...
                     <tr>
                       ...
                       <td><a href="{{url('admin/list_salaire/'.$opt->id)}}" class="btn btn-info height-auto btn-sm mt-2" style="width:100%; background-color:blue">Salary List</a></td>
          ...
          <div class="col-md-6">
            <div class="row mb-5">
              <div class="col-md-6 mb-3 mb-md-0">
                <a href="{{url('admin/list_phamacie')}}" onclick="destroy_session_pharmacie()"><button class="btn btn-primary btn-md btn-block">Sign Out</button></a>
              </div>
              <div class="col-md-6">
              </div>
            </div>
